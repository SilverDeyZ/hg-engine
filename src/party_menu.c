...
// Badge requirements indexed by (fieldEffect - PARTY_MON_CONTEXT_MENU_FIELD_MOVES_BEGIN).
// Order matches PartyMonContextMenuItem: CUT FLY SURF STRENGTH ROCK_SMASH WATERFALL ROCK_CLIMB WHIRLPOOL FLASH ...
// 0xFF = no badge required (non-HM field moves or ungated HMs).
static const u8 sHMBadgeRequirements[] = {
    ...
    0xFF,                   // idx 8 — PARTY_MON_CONTEXT_MENU_FLASH       (24)
    0xFF,                   // idx 9 — PARTY_MON_CONTEXT_MENU_TELEPORT    (25)
    0xFF,                   // idx 10 — PARTY_MON_CONTEXT_MENU_DIG        (26)
    0xFF,                   // idx 11 — PARTY_MON_CONTEXT_MENU_SWEET_SCENT(27)
    0xFF,                   // idx 12 — PARTY_MON_CONTEXT_MENU_CHATTER    (28)
    0xFF,                   // idx 13 — PARTY_MON_CONTEXT_MENU_HEADBUTT   (29)
    0xFF,                   // idx 14 — PARTY_MON_CONTEXT_MENU_MILK_DRINK (30)
    0xFF,                   // idx 15 — PARTY_MON_CONTEXT_MENU_SOFTBOILED (31)
};
#endif
