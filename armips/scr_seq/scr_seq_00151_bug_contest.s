...
.if BUG_CONTEST_PRIZE_CONFIG == 1
_BugContestRemapPrize:
	compare VAR_TEMP_x4000, 0
	goto_if_eq _BugContestPrize_First
	compare VAR_TEMP_x4000, 1
	goto_if_eq _BugContestPrize_Second
	compare VAR_TEMP_x4000, 2
	goto_if_eq _BugContestPrize_Third
	setvar VAR_TEMP_x4001, BUG_CONTEST_CONSOLATION_PRIZE
	return

_BugContestPrize_First:
	count_badges VAR_SPECIAL_RESULT
	compare VAR_SPECIAL_RESULT, BUG_CONTEST_ROUND_2_BADGE_COUNT
	goto_if_lt _BugContestPrize_FirstRound
	random VAR_SPECIAL_RESULT, BUG_CONTEST_SECOND_ROUND_PRIZE_COUNT
	compare VAR_SPECIAL_RESULT, 0
	goto_if_eq _BugContestPrize_SecondRound_0
	compare VAR_SPECIAL_RESULT, 1
	goto_if_eq _BugContestPrize_SecondRound_1
	compare VAR_SPECIAL_RESULT, 2
	goto_if_eq _BugContestPrize_SecondRound_2
	compare VAR_SPECIAL_RESULT, 3
	goto_if_eq _BugContestPrize_SecondRound_3
	compare VAR_SPECIAL_RESULT, 4
	goto_if_eq _BugContestPrize_SecondRound_4
	compare VAR_SPECIAL_RESULT, 5
	goto_if_eq _BugContestPrize_SecondRound_5
	compare VAR_SPECIAL_RESULT, 6
	goto_if_eq _BugContestPrize_SecondRound_6
	compare VAR_SPECIAL_RESULT, 7
	goto_if_eq _BugContestPrize_SecondRound_7
	compare VAR_SPECIAL_RESULT, 8
	goto_if_eq _BugContestPrize_SecondRound_8
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_9_PRIZE
	return

_BugContestPrize_FirstRound:
	setvar VAR_TEMP_x4001, BUG_CONTEST_FIRST_ROUND_PRIZE
	return

_BugContestPrize_SecondRound_0:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_0_PRIZE
	return

_BugContestPrize_SecondRound_1:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_1_PRIZE
	return

_BugContestPrize_SecondRound_2:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_2_PRIZE
	return

_BugContestPrize_SecondRound_3:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_3_PRIZE
	return

_BugContestPrize_SecondRound_4:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_4_PRIZE
	return

_BugContestPrize_SecondRound_5:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_5_PRIZE
	return

_BugContestPrize_SecondRound_6:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_6_PRIZE
	return

_BugContestPrize_SecondRound_7:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_7_PRIZE
	return

_BugContestPrize_SecondRound_8:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_ROUND_8_PRIZE
	return

_BugContestPrize_Second:
	setvar VAR_TEMP_x4001, BUG_CONTEST_SECOND_PLACE_PRIZE
	return

_BugContestPrize_Third:
	setvar VAR_TEMP_x4001, BUG_CONTEST_THIRD_PLACE_PRIZE
	return
.endif
...
_053C:
	.byte 0x0f, 0x00, 0x05, 0x00, 0xfe, 0x00, 0x00, 0x00

_0544:
	.byte 0x0e, 0x00, 0x05, 0x00, 0xfe, 0x00, 0x00, 0x00
